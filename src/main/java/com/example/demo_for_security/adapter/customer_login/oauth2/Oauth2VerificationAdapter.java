...
public class Oauth2VerificationAdapter  implements LhitSecurityUserVerificationAdapter<Oauth2Verification> {
    ...
    @Override
    public LhitSecurityUserPerms verification(Oauth2Verification verification) throws Exception {
